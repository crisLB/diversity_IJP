...
ab1main$eig[1:2]/sum(ab1main$eig) # Percetange of variation explained by each axes: most of the variation is reflected by the first axis
...
ab1mainFD$eig[1:2]/sum(ab1mainFD$eig) # Percentange of variation explained by each axes: most of the variation is reflected by the first axis
...
s.label(ab1mainFD$l2) # Positions of the levels of factor A - hosts species - on its principal axes in the FD space
ab1mainPD$eig[1:2]/sum(ab1mainPD$eig) # Percentange of variation explained by each axes
