...
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-26-1.png" alt="Figure 1. Parasite a diversity in terms of taxonomy (TD), functional traits (FD) and a proxy of the phylogeny (PPD) for each host individual of each fish species. Different lowercase letters indicate significant differences between host species"  />
<p class="caption">
...
We calculate β1 and β2 diversities under the equivalent number approach (Ricotta and Szeidl, 2009), using the third proposition of the Rao index of diversity in Pavoine et al. (2016, <https://doi.org/10.1111/2041-210X.12591>) specifically developed for unbalanced samplings. \* β TD
...
```
    ...
    ## 
    ## Based on 847 replicates
    ## Simulated p-value: 0.007075472 
    ## Alternative hypothesis: two-sided 
    ## 
    ##      Std.Obs  Expectation     Variance 
    ## -2.623813101  0.164354880  0.000516241
...
```
    ...
    ## 
    ##      Std.Obs  Expectation     Variance 
    ## 1.320318e+01 2.402494e-02 3.532032e-04
...
```
    ...
    ## 
    ## Based on 834 replicates
    ## Simulated p-value: 0.08383234 
    ## Alternative hypothesis: two-sided 
    ## 
    ##       Std.Obs   Expectation      Variance 
    ## -1.7303665613  0.0893000550  0.0001953435
...
```
    ...
    ## 
    ##      Std.Obs  Expectation     Variance 
    ## 1.393947e+01 7.069589e-03 1.986353e-05
...
```
    ...
    ## 
    ## Based on 831 replicates
    ## Simulated p-value: 0.1694712 
    ## Alternative hypothesis: two-sided 
    ## 
    ##       Std.Obs   Expectation      Variance 
    ## -1.3812273884  0.0751351512  0.0001722778
...
```
    ...
    ## 
    ##      Std.Obs  Expectation     Variance 
    ## 1.295825e+01 5.313473e-03 1.154367e-05
...
```
    ...
    ## 
    ## Based on 961 replicates
    ## Simulated p-value: 0.8357588 
    ## Alternative hypothesis: two-sided 
    ## 
    ##      Std.Obs  Expectation     Variance 
    ## -0.342060030  0.182259037  0.002637128
...
```
    ...
    ## 
    ##      Std.Obs  Expectation     Variance 
    ## 13.874285579  0.078652783  0.002567765
...
```
    ...
    ## 
    ## Based on 965 replicates
    ## Simulated p-value: 0.6242236 
    ## Alternative hypothesis: two-sided 
    ## 
    ##       Std.Obs   Expectation      Variance 
    ## -0.6161733558  0.0652917986  0.0002302003
...
```
    ...
    ## 
    ##      Std.Obs  Expectation     Variance 
    ## 1.028212e+01 2.017906e-02 1.920701e-04
...
```
    ...
    ## 
    ## Based on 974 replicates
    ## Simulated p-value: 0.4830769 
    ## Alternative hypothesis: two-sided 
    ## 
    ##       Std.Obs   Expectation      Variance 
    ## -0.7604346001  0.0542205868  0.0001609078
...
```
    ...
    ## 
    ##      Std.Obs  Expectation     Variance 
    ## 11.020659771  0.018168632  0.000157224
...
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-41-1.png" style="display: block; margin: auto;" />
...
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-42-1.png" style="display: block; margin: auto;" />
...
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-43-1.png" style="display: block; margin: auto;" />
...
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-44-1.png" style="display: block; margin: auto;" />
...
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-45-1.png" style="display: block; margin: auto;" />
...
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-46-1.png" style="display: block; margin: auto;" />
...
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-47-1.png" style="display: block; margin: auto;" />
...
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-48-1.png" style="display: block; margin: auto;" />
...
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-49-1.png" style="display: block; margin: auto;" />
