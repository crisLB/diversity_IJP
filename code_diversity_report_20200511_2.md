...
<figure>
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-26-1.png">
<figcaption>
...
```
    ...
    ## 
    ## Based on 827 replicates
    ## Simulated p-value: 0.01207729 
    ## Alternative hypothesis: two-sided 
    ## 
    ##       Std.Obs   Expectation      Variance 
    ## -2.4970012223  0.1642368415  0.0005677528
...
```
    ...
    ## 
    ##      Std.Obs  Expectation     Variance 
    ## 1.419752e+01 2.304340e-02 3.078828e-04
...
```
    ...
    ## 
    ## Based on 833 replicates
    ## Simulated p-value: 0.07553957 
    ## Alternative hypothesis: two-sided 
    ## 
    ##       Std.Obs   Expectation      Variance 
    ## -1.7636975764  0.0890566985  0.0001842648
...
```
    ...
    ## 
    ##      Std.Obs  Expectation     Variance 
    ## 1.352962e+01 7.253107e-03 2.096082e-05
...
```
    ...
    ## 
    ## Based on 846 replicates
    ## Simulated p-value: 0.1617473 
    ## Alternative hypothesis: two-sided 
    ## 
    ##       Std.Obs   Expectation      Variance 
    ## -1.3922066647  0.0747946692  0.0001632617
...
```
    ...
    ## 
    ##      Std.Obs  Expectation     Variance 
    ## 1.447504e+01 5.064607e-03 9.356065e-06
...
<figure>
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-33-1.png">
<figcaption>
</figcaption>
</figure>
...
```
    ...
    ## 
    ## Based on 969 replicates
    ## Simulated p-value: 0.8443299 
    ## Alternative hypothesis: two-sided 
    ## 
    ##      Std.Obs  Expectation     Variance 
    ## -0.378888895  0.184184913  0.002646516
...
```
    ...
    ## 
    ##      Std.Obs  Expectation     Variance 
    ## 13.509711406  0.078311484  0.002710853
...
```
    ...
    ## 
    ## Based on 962 replicates
    ## Simulated p-value: 0.6417445 
    ## Alternative hypothesis: two-sided 
    ## 
    ##       Std.Obs   Expectation      Variance 
    ## -0.5581849563  0.0646231370  0.0002418227
...
```
    ...
    ## 
    ##     Std.Obs Expectation    Variance 
    ## 9.907941289 0.019919347 0.000207606
...
```
    ...
    ## Simulated p-value: 0.4404145 
    ## Alternative hypothesis: two-sided 
    ## 
    ##       Std.Obs   Expectation      Variance 
    ## -0.8196159493  0.0545634348  0.0001485307
...
```
    ...
    ## 
    ##      Std.Obs  Expectation     Variance 
    ## 1.082556e+01 1.879273e-02 1.614735e-04
...
<figure>
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-40-1.png">
<figcaption>
</figcaption>
</figure>
...
<figure>
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-41-1.png">
<figcaption>
</figcaption>
</figure>
``` r
...
<figure>
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-42-1.png">
<figcaption>
</figcaption>
</figure>
``` r
...
<figure>
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-43-1.png">
<figcaption>
</figcaption>
</figure>
``` r
...
<figure>
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-44-1.png">
<figcaption>
</figcaption>
</figure>
``` r
...
<figure>
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-45-1.png">
<figcaption>
</figcaption>
</figure>
``` r
...
<figure>
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-46-1.png">
<figcaption>
</figcaption>
</figure>
``` r
...
<figure>
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-47-1.png">
<figcaption>
</figcaption>
</figure>
``` r
...
<figure>
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-48-1.png">
<figcaption>
</figcaption>
</figure>
``` r
...
<figure>
<img src="code_diversity_report_20200508_files/figure-markdown_github/unnamed-chunk-49-1.png">
<figcaption>
</figcaption>
</figure>
``` r
